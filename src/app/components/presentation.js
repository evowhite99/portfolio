...
export default function Presentation({ language }) {
  return (
    <div className="flex items-center justify-center ">
      <div className="relative  flex flex-col justify-center lg:p-10 p-2 h-40 rounded-2xl  hover:bg-blue-400 hover:bg-opacity-60 duration-300 lg:mt-40    mb-20 mr-5 ml-5">

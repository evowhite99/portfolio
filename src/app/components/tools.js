  ...
  return (
    <div className="relative w-full flex flex-col justify-center p-10 mt-52 mb-52">
      <div className="text-center text-white mb-6">
        <div
          id="custom-shadow"
          className="custom-shadow hover:bg-blue-400 hover:bg-opacity-80 duration-300 rounded-3xl pt-5 pb-5"
        >
        ...
        <div
          id="custom-shadow"
          className="custom-shadow hover:bg-blue-400 hover:bg-opacity-80 duration-300 rounded-3xl pt-5 pb-5 mt-32"
        >
          <h1 className="text-3xl font-bold mb-5">

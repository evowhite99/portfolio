...
function Projects({ language }) {
  ...
  const handleInfoClick = useCallback((index) => {
  ...
  return (
    ...
    >
      ...
      <div className="text-center text-white mb-6">
        <div
          id="custom-shadow"
          className="custom-shadow rounded-2xl mx-auto lg:w-2/6 p-2 hover:bg-blue-400 hover:bg-opacity-80 duration-300"
        >
          <h1 className="text-3xl font-bold">
            {languages[language].titleProjects}
          </h1>
          <div>{languages[language].descriptionProjects}</div>
        </div>
      </div>
      ...
      <div className="text-center text-white mt-20 mb-6">
        <div
          id="custom-shadow"
          className="custom-shadow rounded-2xl mx-auto lg:w-3/12 p-2 w-9/12 hover:bg-blue-400 hover:bg-opacity-80 duration-300"
        >
          <h1 className="text-3xl font-bold">
